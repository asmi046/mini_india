    ...
    <tbody>
           @foreach ($formData['tovars'] as $item)
                ...
                <tr>
                    ...
                    <td style="padding: 5px; border-bottom:1px solid black; border-right:1px solid black;">{{$item["tovar_data"]["title"]}}<br/><span style="font-size:12px">{{$item["tovar_data"]["brand"]}}</span></td>
